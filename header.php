...
<header id="header">
    <div class="menu_mb butt_mobile visible-xs visible-sm clearfix">
        ...
        <div class="text-center">
            <a href="<?php echo base_url();?>"> <img style="    height: 40px;
    width: 180px;
    
    margin-top: 8px;  " src="<?php echo $this->fcSystem['homepage_logo'] ?>"/> </a>
                    ...
                    <div class="col-lg-8 col-md-6 col-sm-8 col-xs-8">
                        <ul class="ul_top_header">
                            ...
                            <li style="padding: 10px;">
                                <a href="">
                                    <span class="bf_map"> Email:</span>
                                    <?php echo $this->fcSystem['contact_email'] ?>
                                </a>
                            </li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-4 col-xs-4">
                        <div class="right_top_header">
                            <div class="right_icon hidden-sm hidden-xs">
                                ...
                                <?php /* <a class="fab fa-youtube-square" href="<?php echo $this->fcSystem['social_youtube'] ?>" target="_blank"></a>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <div id="sb-search" class="sb-search">
                            <form action="tim-kiem.html" method="get">
                                <input class="sb-search-input" style="color: black;" placeholder="<?php echo $this->lang->line('search')?>" type="text"
