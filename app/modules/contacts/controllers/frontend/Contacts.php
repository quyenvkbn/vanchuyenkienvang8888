...
//			 $this->form_validation->set_rules('congty', $this->lang->line('contact_congty'), 'trim|required');
//			 $this->form_validation->set_rules('chucvu', $this->lang->line('contact_chucvu'), 'trim|required');
