						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<label class="col-sm-1 control-label">Số ĐT</label>
									<div class="col-sm-5">
										<?php echo form_input('phone', set_value('phone', $detailContact['phone']), 'class="form-control" placeholder=""');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">Thời gian đăng ký</label>
									<div class="col-sm-4">
										<?php echo form_input('created', set_value('created', gettime($detailContact['created'])), 'class="form-control" placeholder="" readonly="true"');?>
									</div>
									<label class="col-sm-1 control-label">Địa chỉ</label>
									<div class="col-sm-5">
										<?php echo form_input('address', set_value('address', $detailContact['address']), 'class="form-control" placeholder=""');?>
									</div>
								</div>
