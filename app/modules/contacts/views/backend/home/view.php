	  ...
	  <div class="box">
		<div class="box-header">
			<h3 class="box-title pull-right">
				<div class="btn-group" >
					<a href="<?php echo site_url('contacts/backend/home/exportEcel');?>" class="btn btn-default btn-flat" style="background-color: #95d61a;color: #fff;" ><i class="fa fa-plus"></i> Xuất Excel</a>
				</div>
			</h3>
...
<!--					<td>--><?php //echo $contact['hedaotao'];?><!--</td>-->
<!--					<td>--><?php //echo $contact['chucvu'];?><!--</td>-->
