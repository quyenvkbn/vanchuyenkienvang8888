						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-5">
										<?php echo form_input('phone', set_value('phone', $DetailComments['phone']), 'class="form-control" placeholder="Số điện thoại"');?>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<?php echo form_textarea('contents', htmlspecialchars_decode(set_value('contents', $DetailComments['contents'])), 'class="textarea" placeholder="Nội dung" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
