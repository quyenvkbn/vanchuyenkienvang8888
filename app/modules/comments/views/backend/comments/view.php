<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active"><a href="<?php echo site_url('comments/backend/comments/view');?>">Danh sách hỏi đáp</a></li>
	</ol>
</section>
...
//					echo "<pre>";var_dump($object);die;
				...
				<tr>
					...
					<td class=""><?php echo $comment['fullname']; ?><br/><?php echo $comment['phone'];?> </td></td>
					<td style="text-align:center;"><?php for($i = 1; $i <= 5; $i++){ ?> <i class="fa fa-star" style="<?php echo ($i <= $comment['star']) ? 'color:#FD4' : ''; ?>"></i> <?php  } ?></td>

					<td class="hide"><?php echo ((!empty($comment['parentid'])) ? 'Cấp 2 (Trả lời)' : 'Cấp 1(Bình luận)') ?></td>
					<td style="text-align:center;"><a target="_blank" href="<?php echo $href; ?>" title="<?php echo $object['title']; ?>"><?php echo $object['title'] ?> <i class="fa fa-link"></i></a></td>
					<td><?php echo strip_tags($comment['message']);?></td>
					...
					<td class="text-center">
                        ...
                        <tr>
                            ...
                            <td class="">|----------<?php echo $comments['fullname']; ?><br/><?php echo $comments['phone'];?> </td></td>
                            ...
                            <td><?php echo cutnchar(strip_tags($comments['contents']), 300);?></td>
                            ...
                            <td class="text-center">
                                <div class="btn-group" style="min-width: 80px;">
                                    <a href="<?php echo site_url('comments/backend/comments/delete/'.$comments['id']).'?redirect='.urlencode(current_url());?>" class="btn btn-default"><span class="fa fa-trash"></span></a>
