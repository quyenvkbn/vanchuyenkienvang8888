							...
							<div class="tab-pane active" id="tab-info">
								<div class="box-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<?php echo form_textarea('bongda', htmlspecialchars_decode(set_value('bongda', $DetailArticlesCatalogues['bongda'])), 'id="txtbongda" class="ckeditor-description" placeholder="Nội dung" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
										</div>
									</div>
								</div><!-- /.box-body -->
							</div><!-- /.tab-pane -->
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-seo">
							<div class="box-body">
								...
								<div class="hidden">
									<div class="form-group">
										<label class="col-sm-12 control-label tp-text-left">Ảnh đại diện 2</label>
									</div>
									<div class="form-group">
										<div class="col-sm-12">
											<div class="avatar" style="margin-bottom: 10px;cursor: pointer;"><img src="<?php echo (isset($DetailArticlesCatalogues['images1']) && !empty($DetailArticlesCatalogues['images1']))?$DetailArticlesCatalogues['images1']: 'templates/not-found.png'; ?>" class="img-thumbnail" alt="" style="width: 100%;border-radius: 0;" /></div>
											<?php echo form_input('images1', set_value('images1', (isset($DetailArticlesCatalogues['images1']) && !empty($DetailArticlesCatalogues['images1']))?$DetailArticlesCatalogues['images1']: ''), 'class="form-control"  placeholder="Ảnh đại diện" onclick="openKCFinder(this)" ');?>
										</div>
									</div>
								</div>
								<div class="form-group">
