							...
							<div class="tab-pane active" id="tab-info">
								<div class="box-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<?php echo form_textarea('bongda', htmlspecialchars_decode(set_value('bongda', $DetailArticlesCatalogues['bongda'])), 'id="txtbongda" class="ckeditor-description" placeholder="Mô tả" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
										</div>
									</div>
								</div><!-- /.box-body -->
							</div><!-- /.tab-pane -->
