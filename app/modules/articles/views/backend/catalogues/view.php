...
<!--					<td>-->
<!--						<a href="--><?php //echo site_url('articles/backend/catalogues/set/ishit/'.$item['id'].'?redirect='.urlencode(current_url())); ?><!--" title="" class="status-publish">-->
<!--							<img src="--><?php //echo (!empty($item['ishit']))? 'templates/backend/images/publish-check.png':'templates/backend/images/publish-deny.png'; ?><!--" alt="" />-->
<!--						</a>-->
<!--					</td>-->
<!--					<td>-->
<!--						<a href="--><?php //echo site_url('articles/backend/catalogues/set/isis/'.$item['id'].'?redirect='.urlencode(current_url())); ?><!--" title="" class="status-publish">-->
<!--							<img src="--><?php //echo (!empty($item['isis']))? 'templates/backend/images/publish-check.png':'templates/backend/images/publish-deny.png'; ?><!--" alt="" />-->
<!--						</a>-->
<!--					</td>-->
<!--					<td>-->
<!--						<a href="--><?php //echo site_url('articles/backend/catalogues/set/istu/'.$item['id'].'?redirect='.urlencode(current_url())); ?><!--" title="" class="status-publish">-->
<!--							<img src="--><?php //echo (!empty($item['istu']))? 'templates/backend/images/publish-check.png':'templates/backend/images/publish-deny.png'; ?><!--" alt="" />-->
<!--						</a>-->
<!--					</td>-->
