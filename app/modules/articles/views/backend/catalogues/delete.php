<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active"><a href="<?php echo site_url('articles/backend/catalogues/delete/'.$DetailArticlesCatalogues['id']);?>">Xóa Danh mục bài viết</a></li>
	</ol>
</section>
				...
				<section class="invoice">
					...
					<div class="row invoice-info">
						<div class="col-sm-4 invoice-col">
							...
							<input type="hidden" value="<?php echo $DetailArticlesCatalogues['id'] ?>" name="cataloguesid_showhome" />
							</address>
						</div><!-- /.col -->
