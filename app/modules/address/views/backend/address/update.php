						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<?php echo form_input('title', set_value('title', $Detailaddress['title']), 'class="form-control" placeholder="Tên files"');?>
									</div>
								...
								<div class="form-group hide">
									...
									<div class="col-sm-4">
										<?php echo form_input('size', set_value('size', $Detailaddress['size']), 'class="form-control" placeholder="Kích thước"');?>
									</div>
