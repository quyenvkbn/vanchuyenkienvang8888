			...
			<div class="col-md-9">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						...
						<!-- <li><a href="#tab-album" data-toggle="tab">Album ảnh 360</a></li> -->
						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								...
								<div class="form-group ">
									...
									<div class="col-sm-10">
										<?php echo form_textarea('content4', htmlspecialchars_decode(set_value('content4')), 'id="txtContent4" class="ckeditor-description" placeholder="Thông tin chi tiết" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								...
								<div class="form-group ">
									...
									<div class="col-sm-10">
										<?php echo form_textarea('tongquan', htmlspecialchars_decode(set_value('tongquan')), 'id="txttongquan" class="ckeditor-description" placeholder="" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								<div class="form-group hidden ">
									<label class="col-sm-2 control-label tp-text-left">Thông tin chi tiết</label>
									<div class="col-sm-10">
										<?php echo form_textarea('daigia', htmlspecialchars_decode(set_value('daigia')), 'id="txtdaigia" class="ckeditor-description" placeholder="" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								<div class="form-group hide hide">
									<label class="col-sm-2 control-label tp-text-left">BẢn Đồ</label>
									<div class="col-sm-10">
										<?php echo form_textarea('bando', set_value('bando'), 'class="form-control" placeholder="bando" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">Thời gian</label>
									<div class="col-sm-10">
										<?php echo form_textarea('ttbando', htmlspecialchars_decode(set_value('ttbando')), 'id="txtttbando" class="ckeditor-description" placeholder="" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								...
								<div class="form-group hide ">
									...
									<div class="col-sm-10">
										<?php echo form_input('item1', set_value('item1'), 'class="form-control" placeholder=""');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">Giờ</label>
									<div class="col-sm-10">
										<?php echo form_input('item11', set_value('item11'), 'class="form-control" placeholder=""');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">Giải</label>
									<div class="col-sm-10">
										<?php echo form_input('item2', set_value('item2'), 'class="form-control" placeholder=""');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">Đội 1</label>
									<div class="col-sm-10">
										<?php echo form_input('item21', set_value('item21'), 'class="form-control" placeholder=""');?>
									</div>
								</div>
								<div class="form-group hide ">
									<label class="col-sm-2 control-label tp-text-left">Tỷ Lệ</label>
									<div class="col-sm-10">
										<?php echo form_input('item3', set_value('item3'), 'class="form-control" placeholder=""');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">Đội 2</label>
									<div class="col-sm-10">
										<?php echo form_input('item31', set_value('item31'), 'class="form-control" placeholder=""');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">Chọn</label>
									<div class="col-sm-10">
										<?php echo form_input('item4', set_value('item4'), 'class="form-control" placeholder=""');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">KT</label>
									<div class="col-sm-10">
										<?php echo form_input('item41', set_value('item41'), 'class="form-control" placeholder=""');?>
									</div>
								</div>
								<div class="form-group hide ">
									<label class="col-sm-2 control-label tp-text-left">KQ</label>
									<div class="col-sm-10">
										<?php echo form_input('item5', set_value('item5'), 'class="form-control" placeholder=""');?>

									</div>
								</div>
								<div class="form-group hide ">
									<label class="col-sm-2 control-label tp-text-left">fdsfds</label>
									<div class="col-sm-10">
										<?php echo form_input('item51', set_value('item51'), 'class="form-control" placeholder=""');?>
									</div>
								</div>
								...
								<div class="form-group hide">
									...
									<div class="col-sm-10">
										<?php echo form_textarea('mb', htmlspecialchars_decode(set_value('mb')), 'id="txtmb" class="ckeditor-description" placeholder="" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">STUDIO TẦNG 5</label>
									<div class="col-sm-10">
										<?php echo form_textarea('studio', htmlspecialchars_decode(set_value('studio')), 'id="txtstudio" class="ckeditor-description" placeholder="" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								...
								<div class="form-group hide">
									...
									<div class="col-sm-10">
										<?php echo form_textarea('1pn', htmlspecialchars_decode(set_value('1pn')), 'id="txt1pn" class="ckeditor-description" placeholder="" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">2PN(+) TẦNG 5</label>
									<div class="col-sm-10">
										<?php echo form_textarea('2pn', htmlspecialchars_decode(set_value('2pn')), 'id="txt2pn" class="ckeditor-description" placeholder="" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">ĐIỂM KHÁC BIỆT CHỈ CÓ TẠI DỰ ÁN SCENIA BAY</label>
									<div class="col-sm-10">
										<?php echo form_textarea('dacdiem', htmlspecialchars_decode(set_value('dacdiem')), 'id="txtdacdiem" class="ckeditor-description" placeholder="" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">TRƯỚC KHI KÝ HĐMB</label>
									<div class="col-sm-10">
										<?php echo form_textarea('truockhiky', htmlspecialchars_decode(set_value('truockhiky')), 'id="txttruockhiky" class="ckeditor-description" placeholder="" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left"> KHI KÝ HĐMB</label>
									<div class="col-sm-10">
										<?php echo form_textarea('khiky', htmlspecialchars_decode(set_value('khiky')), 'id="txtkhiky" class="ckeditor-description" placeholder="" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">Tiện ích</label>
									<div class="col-sm-10">
										<?php echo form_textarea('tienich', htmlspecialchars_decode(set_value('tienich')), 'id="txttienich" class="ckeditor-description" placeholder="" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								...
								<div class="form-group hide">
									...
									<div class="col-sm-10">
										<?php echo form_textarea('content', htmlspecialchars_decode(set_value('content')), 'id="txtContent" class="ckeditor-description" placeholder="Thông số" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">Hình ảnh</label>
									<div class="col-sm-10">
										<?php echo form_textarea('content3', htmlspecialchars_decode(set_value('content3')), 'id="txtContent3" class="ckeditor-description" placeholder="Hình ảnh" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								
								<div class="form-group hide">
									<label class="col-sm-2 control-label tp-text-left">Khuyến mại</label>
									<div class="col-sm-10">
										<?php echo form_textarea('content2', htmlspecialchars_decode(set_value('content2')), 'id="txtContent2" class="ckeditor-description" placeholder="Thông tin Tham số" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
					...
					<div class="tab-pane" id="tab-album-list">
						<div class="box-body">
							<div class="form-group" id="fromSlidelist">
								<?php $albumlist = $this->input->post('albumlist'); if(isset($albumlist) && is_array($albumlist) && count($albumlist)){ ?>
									<?php foreach($albumlist['images'] as $key => $val){ if(empty($albumlist['images'][$key])) continue;?>
									<div class="col-sm-3 slideItem">
										<div class="thumb"><img src="<?php echo $albumlist['images'][$key];?>" class="img-thumbnail img-responsive"/></div>
										<input type="hidden" name="albumlist[images][]" value="<?php echo $albumlist['images'][$key];?>" />
										<input type="text" name="albumlist[title][]" value="<?php echo $albumlist['title'][$key];?>" class="form-control title" placeholder="Tên ảnh" />
										<textarea name="albumlist[description][]" cols="40" rows="10" class="form-control description" placeholder="Mô tả ảnh"><?php echo $albumlist['description'][$key];?></textarea>
