					...
					<div class="uk-width-medium-6-10">
						<div class="uk-panel customer mb20">
							...
							<div class="panel-body">
								...
								<div class=" uk-clearfix mb15">
									<div class="col left"><label for="" class="label">Email <span class="no-required">(<?php echo $this->lang->line('no-required') ?>)</span></label></div>
								...
								<div class=" uk-clearfix mb15">
									<div class="col left"><label for="" class="label"><?php echo $this->lang->line('order_payment_note') ?> <span class="no-required">(<?php echo $this->lang->line('no-required') ?>)</span></label></div>
									<div class="col right"><textarea name="message" class="text uk-width-1-1" placeholder="<?php echo $this->lang->line('note_message') ?>"></textarea></div>
								</div>
							</div>
						</div><!-- .uk-panel -->
										...
										<div class="colinfo uk-float-right">
											<div class=" uk-flex uk-flex-space-between mb10">
												...
												<div class="price_tt">
													...
													<div class="quantity" style="color:red;">x<input class="fc-cart-update" data-id="<?php echo $val['rowid'] ?>" type="text" value="<?php echo number_format($val['qty']);?>" name="<?php echo $i ?>[qty]" style="width:35px;text-align: center;margin-left: 10px;height: 25px;border-color: #ececec;" /></div>
