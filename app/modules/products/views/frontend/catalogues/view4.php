                            ...
                            <?php foreach ($productsList as $key => $val) { ?>
                                ...
                                <div class="storyWork wow fadeInUp">
                                    ...
                                    <div class="textBox">
                                        ...
                                        <div class="storyInfo">
                                            <div class="item">
                                                <span class="left">Th? tr??ng:</span> <span class="right"><?php echo $val['thitruong'] ?></span>
                                            </div>
                                            <div class="item">
                                                <span class="left">L??ng:</span> <span class="right"><?php echo $val['thunhap'] ?></span>
                                            </div>
                                            <div class="item">
                                                <span class="left">Công vi?c:</span> <span class="right"><?php echo $val['congviec'] ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
