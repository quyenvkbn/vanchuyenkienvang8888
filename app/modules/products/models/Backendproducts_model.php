...
class BackendProducts_Model extends FC_Model{
	...
	public function Create($user = '', $catalogues = NULL, $albums = '', $album = '', $lang = 'vietnamese'){
		...
		$data = array(
			...
			'tongquan' => $this->input->post('tongquan'),
			'daigia' => $this->input->post('daigia'),
			'bando' => $this->input->post('bando'),
			'ttbando' => $this->input->post('ttbando'),

			'item1' => $this->input->post('item1'),
			'item11' => $this->input->post('item11'),
			'item2' => $this->input->post('item2'),
			'item21' => $this->input->post('item21'),
			'item3' => $this->input->post('item3'),
			'item31' => $this->input->post('item31'),
			'item4' => $this->input->post('item4'),
			'item41' => $this->input->post('item41'),
			'item5' => $this->input->post('item5'),
			'item51' => $this->input->post('item51'),
			'mb' => $this->input->post('mb'),
			'studio' => $this->input->post('studio'),
			'1pn' => $this->input->post('1pn'),
			'2pn' => $this->input->post('2pn'),
			'dacdiem' => $this->input->post('dacdiem'),
			'truockhiky' => $this->input->post('truockhiky'),
			'khiky' => $this->input->post('khiky'),
			'tienich' => $this->input->post('tienich'),
	...
	public function UpdateByPost($field = '', $value = 0, $user = '',  $catalogues = NULL, $albums = '', $album = ''){
		$price = (int)str_replace('.','',$this->input->post('price'));
		$saleoff = (int)str_replace('.','',$this->input->post('saleoff'));
		$data = array(
			'title' => $this->input->post('title'),
