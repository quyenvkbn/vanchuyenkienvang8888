	...
	public function Create(){
		...
		if($this->input->post('create')){
			...
			if ($this->form_validation->run($this)){
				...
				$resultid = $this->BackendProducts_Model->Create($this->fcUser,$data['catalogue'], $album_data, $album_data_2, $this->fclang);
				if($resultid > 0){
	...
	public function Update($id = 0){
		...
		if($this->input->post('update')){
			...
			if ($this->form_validation->run($this)){
				...
				$flag = $this->BackendProducts_Model->UpdateByPost('id', $id, $this->fcUser, $catalogues, $album_data, $album_data_2);
				if($flag > 0){
					$temp = '';
